...
struct TransactionOtpView: View {
...
struct TransactionOtpView_Previews: PreviewProvider {
    static var previews: some View {
        TransactionOtpView(password: "", phoneNumber: "", pinAtm: "")
    }
}
