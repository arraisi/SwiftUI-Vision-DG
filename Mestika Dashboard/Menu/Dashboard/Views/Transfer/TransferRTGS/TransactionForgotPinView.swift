...
struct TransactionForgotPinView: View {
    ...
    var body: some View {
        if pinView {
            TransactionValidationPinAtmView(password: self.pinCtrl)
        } else {
            ZStack {
                    ...
                    ScrollView(showsIndicators: false) {
                        ...
                        VStack {
                            ...
                            VStack(alignment: .leading) {
                                ...
                                VStack {
                                    HStack {
                                        SecureField("Enter your new PIN Transaction".localized(language), text: self.$pinCtrl)
                                    ...
                                    HStack {
                                        SecureField("Enter your new PIN Transaction".localized(language), text: self.$pinConfirmCtrl)
                                            .keyboardType(.numberPad)
                            ...
                            Button(action: {
                                ...
                                Text("Save New PIN Transaction".localized(language))
