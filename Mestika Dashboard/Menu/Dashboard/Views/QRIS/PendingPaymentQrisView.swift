//
//  PendingPaymentQrisView.swift
//  Mestika Dashboard
//
//  Created by Prima Jatnika on 20/04/21.
//

import SwiftUI

struct PendingPaymentQrisView: View {
    ...
    var body: some View {
        VStack {
            ...
            VStack(spacing: 15) {
                ...
                Text("Transaction in progress, please wait a while")
...
struct PendingPaymentQrisView_Previews: PreviewProvider {
