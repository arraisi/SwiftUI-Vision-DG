//
//  CardLimitPinView.swift
//  Mestika Dashboard
//
//  Created by Prima Jatnika on 24/05/21.
//

import SwiftUI

struct CardLimitPinView: View {
...
struct CardLimitPinView_Previews: PreviewProvider {
    static var previews: some View {
        CardLimitPinView(wrongPin: .constant(false)) { pin in
