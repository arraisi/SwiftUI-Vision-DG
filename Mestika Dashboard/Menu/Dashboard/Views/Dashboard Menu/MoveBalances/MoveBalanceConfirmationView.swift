//
//  MoveBalanceConfirmationView.swift
//  Mestika Dashboard
//
...
struct MoveBalanceConfirmationView: View {
    ...
    var body: some View {
        ZStack {
            ...
            NavigationLink(
                destination: MoveBalancePinView().environmentObject(transactionData),
...
struct MoveBalanceConfirmationView_Previews: PreviewProvider {
    static var previews: some View {
        MoveBalanceConfirmationView().environmentObject(MoveBalancesModel())
    }
}
