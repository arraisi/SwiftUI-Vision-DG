//
//  FormRegisterVerificationPinScreen.swift
//  Mestika Dashboard
//
...
struct PinConfirmationRegisterNasabahView: View {
                        ...
                        VStack {
                            ...
                            ZStack {
                                ...
                                ZStack {
                                    ...
                                    .cornerRadius(25.0)
                                    .shadow(color: Color(hex: "#2334D0").opacity(0.2), radius: 15, y: -2)
                                ...
                                .cornerRadius(25.0)
                                .shadow(color: Color(hex: "#2334D0").opacity(0.2), radius: 15, y: 4)
...
struct FormRegisterVerificationPinScreen_Previews: PreviewProvider {
    static var previews: some View {
        PinConfirmationRegisterNasabahView().environmentObject(RegistrasiModel())
    }
}
