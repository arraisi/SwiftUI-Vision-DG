//
//  FormEmailReVerificationNasabahScreen.swift
//  Mestika Dashboard
//
...
struct FormEmailReVerificationNasabahScreen: View {
    ...
    var body: some View {
        ZStack(alignment: .top) {
            ...
            VStack(alignment: .center) {
                ...
                NavigationLink(destination: TujuanPembukaanRekeningRegisterNasabahView().environmentObject(registerData)) {
...
struct FormEmailReVerificationNasabahScreen_Previews: PreviewProvider {
    static var previews: some View {
        FormEmailReVerificationNasabahScreen().environmentObject(RegistrasiModel())
    }
}
