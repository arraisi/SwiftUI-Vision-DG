//
//  TermConditionRegisterNasabahScreen.swift
//  Mestika Dashboard
//
...
struct TermConditionRegisterNasabahScreen_Previews: PreviewProvider {
    static var previews: some View {
        TermConditionRegisterNasabahScreen().environmentObject(RegistrasiModel())
    }
}
