...
struct PinRegisterNasabahView: View {
                        ...
                        VStack {
                            ...
                            ZStack {
                                ...
                                VStack {
                                    ...
                                    NavigationLink(
                                        destination: PinConfirmationRegisterNasabahView().environmentObject(registerData),
...
struct FormRegisterPinNasabahScreen_Previews: PreviewProvider {
    static var previews: some View {
        PinRegisterNasabahView().environmentObject(RegistrasiModel())
    }
}
