                        ...
                        VStack{
                            ...
                            ZStack {
                                ...
                                VStack {
                                    ...
                                    // Sub title
                                    Text("Professional Position".localized(language))
...
struct FormJabatanProfesiView_Previews: PreviewProvider {
    static var previews: some View {
        FormJabatanProfesiView().environmentObject(RegistrasiModel())
    }
}
