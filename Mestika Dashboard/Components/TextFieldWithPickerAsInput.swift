...
struct TextFieldWithPickerAsInput : UIViewRepresentable {
    ...
    func makeCoordinator() -> TextFieldWithPickerAsInput.Coordinator {
        Coordinator(textfield: self)
    }
    
    class Coordinator: NSObject, UIPickerViewDataSource, UIPickerViewDelegate , UITextFieldDelegate {
        
        private let parent : TextFieldWithPickerAsInput
        
        init(textfield : TextFieldWithPickerAsInput) {
